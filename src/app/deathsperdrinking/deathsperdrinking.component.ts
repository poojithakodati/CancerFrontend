...
@Component({
  selector: 'app-deathsperdrinking',
  templateUrl: './deathsperdrinking.component.html',
  styleUrls: ['./deathsperdrinking.component.scss']
})
export class DeathsperdrinkingComponent implements OnInit {
  ...
  {
    this.globalservice.getDeathsfordrinking(year,state).subscribe((response:any)=>{
      if(response)
        {
