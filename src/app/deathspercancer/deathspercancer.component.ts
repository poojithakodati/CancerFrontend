...
@Component({
  selector: 'app-deathspercancer',
  templateUrl: './deathspercancer.component.html',
  styleUrls: ['./deathspercancer.component.scss']
})
export class DeathspercancerComponent implements OnInit {
  ...
  {
    this.globalservice.getDeathsperCancer(year,state).subscribe((response:any)=>{
      if(response)
        {
