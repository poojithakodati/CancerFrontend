...
@Component({
  selector: 'app-deathspersmoking',
  templateUrl: './deathspersmoking.component.html',
  styleUrls: ['./deathspersmoking.component.scss']
})
export class DeathspersmokingComponent implements OnInit {
  ...
  {
    this.globalservice.getDeathsforsmoking(year,state).subscribe((response:any)=>{
      if(response)
        {
